        ...
        <article>
          <div className="about-content">
            ...
            <p>
              ...
              commonplace or rare, you are at the right place. Our mission is to
        ...
        <article className="reverse">
          <div className="about-content">
            ...
            <p>
              ...
              when people are part of our community — whether they are people
              who are interested in working here, global employees, or one of
              the buyers and sellers who transact on our platform — they feel
              included and know that great opportunities are available to them —
        ...
        <article>
          <div className="about-content">
            ...
            <p>
              ...
              more economic opportunity for everyone. There’s a purpose to what
              we’re doing, and we’re very passionate about it. See what it’s
              like to be an engineer at Marketplace.
            </p>
            <Button
              variant="warning"
